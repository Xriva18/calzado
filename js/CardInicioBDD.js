...
$(document).ready(function () {
    $('#cardInicio1').empty();
    $('#cardInicio1S').hide();
    fetch('http://localhost:3000/tbl_inc_ver')
                 ...
                 <div class="col-md-4 my-2">
                    <div class="card shadow border rounded">
                        ...
                        <div class="card-body border" style="height: 300px; background-color: #e3f2fd;">
                            <div style="height: 10%;">
                                <h5 class="card-title">${tbl_inc_ver.nombre} </h5>
                            </div>
                            <div class="card-text mt-4" style="height: 60%;">
                                <p class="text-justify" style="height: 85%;">${tbl_inc_ver.descripcion}</p>
                                <div class="row text-right d-flex justify-content-end mr-2 mb-3">
                                    <p class="font-weight-bold mr-3">Tallas:</p>
                                    <label>
                                        ${tbl_inc_ver.talla1}, ${tbl_inc_ver.talla2}, ${tbl_inc_ver.talla3}
                                    </label>
                                </div>
                                <p class="text-right font-weight-bold"></p>
                                <div class="text-right">
                                    <label class="mr-2">${tbl_inc_ver.precio} $</label>
                                    ${ConoceMas}
                                </div>
                            </div>
                        </div>
...
function imprimirAlerta(j) {
    ...
    fetch('http://localhost:3000/tbl_inc_ver')
        ...
        .then(data => {
            ...
            var tbl_inc_ver = data.find(producto => producto.id === j);
                ...
                <div class="row m-3">
                    <div class="col-lg-5 mt-2">
                        <div class="card mb-3 shadow border rounded">
                            <img class="card-img img-fluid" src="${tbl_inc_ver.imagen1}" alt="Card image cap" id="product-detail">
                        </div>
                        <div class="row">
                                ...
                                <div class="carousel-inner product-links-wap" role="listbox">
                                    <div class="carousel-item active">
                                        <div class="row">
                                            <div class="col">
                                                <a href="#">
                                                    <img class="card-img img-fluid shadow border rounded" style="height: 120px;" src="${tbl_inc_ver.imagen1}" alt="Product Image 1">
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a href="#">
                                                    <img class="card-img img-fluid shadow border rounded" style="height: 120px;" src="${tbl_inc_ver.imagen2}" alt="Product Image 2">
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a href="#">
                                                    <img class="card-img img-fluid shadow border rounded" style="height: 120px;" src="${tbl_inc_ver.imagen3}" alt="Product Image 3">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-7 mt-2">
                        <div class="card">
                            <div class="card-body shadow rounded p-4">
                                <h1 class="h2">${tbl_inc_ver.nombre}</h1>
                                <p class="h3 py-2">$ ${tbl_inc_ver.precio}</p>
                                <h6>Descripción:</h6>
                                <p class="text-justify mt-2 mb-4 ">${tbl_inc_ver.descripcion2}</p>
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="d-inline-block pb-3">
                                            <div class="d-inline-block mr-3 mb-3">Tallas:</div>
                                            <div class="d-inline-block">
                                                <span class="btn btn-primary btn-size text-white m-1" data-value="${tbl_inc_ver.talla1}">${tbl_inc_ver.talla1}</span>
                                                <span class="btn btn-primary btn-size text-white m-1" data-value="${tbl_inc_ver.talla2}">${tbl_inc_ver.talla2}</span>
                                                <span class="btn btn-primary btn-size text-white m-1" data-value="${tbl_inc_ver.talla3}">${tbl_inc_ver.talla3}</span>
                                            </div>
                                            <input type="hidden" id="product-size" value="${tbl_inc_ver.talla1}">
                                            <input type="hidden" id="product-size" value="${tbl_inc_ver.talla2}">
                                            <input type="hidden" id="product-size" value="${tbl_inc_ver.talla3}">
                                        </div>
                                    </div>
                                </div>
                                <!-- Div acontador -->                                
            ...
            $('#cardInicio1S button').eq(0).on('click', () => agregarAlCarrito(tbl_inc_ver));
        })
        .catch(error => console.log('Error:', error));
}
